...
<head>
    ...
    <link href="css/stylesdua.css" rel="stylesheet" />
</head>
                    ...
                    <div class="col-xxl-7">
                        ...
                        <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                            <div class="profile bg-gradient-primary-to-secondary">
                                ...
                                <img src="<?= base_url('uploads/' . session('user')['foto']) ?>" alt="Profile Photo"
                                    class="mt-3" height="400">
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-xxl-8">
                        <div class="text-center my-5">
                            ...
                            <p class="lead fw-light mb-4">hello <?= $name ?>I will help yours brands grow.</p>
                            <!-- Jika Anda ingin menampilkan gambar, gunakan tag <img> dan berikan src sesuai dengan URL gambar -->


                            <p class="text-muted">We always believe a good business relation is an honest one. You can
                                consult us with your project and we'll gladly point out any weakness or bad things you
                                might missed upon your request. If there are any risk in the project we are working on,
                                we will always explain it to you beforehand. However, don't expect us to reveal our past
                                client secret because we value privacy highly. Non Disclosure Agreement is always your
                                option before we begin your project.</p>
